...
if (publicUserEmail.toLowerCase().indexOf("lindacharron13@gmail.com") >= 0) debugEmailTo = "lcharron@truepointsolutions.com";
...
/-----------------------------------------------------------------------------------------------------*/
try {
    Avo_LogDebug("capID:" + cap.capID, 2);  //debug
    ...
    if (parentCapId) {
        ...
        Avo_LogDebug("parentAltId: " + parentAltId + ", parcentCap: " + parentCap, 2);  //debug
    } else {
        Avo_LogDebug("parentCapId: " + parentCapId, 2);  //debug
    }

    if (parentCap) {
        Avo_LogDebug("Processing parent: " + parentAltId + ", parentCapId: " + parentCapId + ", parcentCap: " + parentCap, 2);  //debug
        // Copy Addresses
        ...
        if (allAddrs && allAddrs.size() > 0) {
            ...
            for (var i = 0; i < allAddrs.size(); i++) {
                ...
                Avo_LogDebug("addressModel: " + describe(addrModel), 2);    //debug
